...
class Corpus:
    ...
    :param pickle_on_load: Filepath to sa    >>> from gender_analysis.corpus import Corpus
ve a pickled copy of the corpus
    ...
    def __init__(self, path_to_files, name=None, csv_path=None,
        ...
        if pickle_on_load is not None:
            store_pickle(self, pickle_on_load)
    ...
    def _load_documents_and_metadata(self, path_to_files, csv_path):
        ...
        if path_to_files.suffix == '.pgz':
            pickle_data = load_pickle(path_to_files)
